package com.github.thushear.redis.jedis;
...
public class AdvancedUsage {
    ...
    JedisPool jedisPool = new JedisPool("192.168.56.102",6383);
    ...
    public void testSscan(){
        try (Jedis jedis = jedisPool.getResource()){
            ...
            ScanResult<String> scanResult = jedis.sscan("bs3",ScanParams.SCAN_POINTER_START,scanParams);
